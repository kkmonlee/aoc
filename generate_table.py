...
PROBLEMS = {
    ...
    ("2024", 9): ("Easy", "disk compaction, two-pointer, segment fitting"),
    ("2024", 10): ("Trivial", "DFS, grid traversal, path counting"),
    ("2024", 11): ("Trivial", "memoisation, counting map, digit manipulation"),
    ("2024", 12): ("Easy", "flood fill, perimeter counting, corner detection"),
    ("2024", 13): ("Trivial", "linear algebra, Cramer's rule"),
    ("2024", 14): ("Trivial", "modular arithmetic, position tracking"),
    ("2024", 15): ("Easy", "BFS push propagation, sokoban"),
    ("2024", 16): ("Easy", "Dijkstra, state-space search, all optimal paths"),
    ...
    ("2024", 20): ("Trivial", "BFS, precomputed distances, shortcut enumeration"),
    ("2024", 21): ("Easy", "recursive DP, memoisation, keypad path optimisation"),
    ("2024", 22): ("Trivial", "PRNG, sequence enumeration, hash aggregation"),
    ("2024", 23): ("Easy", "graph triangles, Bron-Kerbosch, max clique"),
    ("2024", 24): ("Medium", "circuit analysis, ripple-carry adder, wire tracing"),
